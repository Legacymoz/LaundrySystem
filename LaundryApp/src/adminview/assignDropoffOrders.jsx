...
const AssignDropoffOrders = ({ orderId, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await assignOrdersToDriver(selectedDriver, { dropoffOrders: [orderId] });
...
export default AssignDropoffOrders;