...
// const ClientPaymentRecord = () => {
//   const clientInfo = useStore((state) => state.clientInfo); // Get client info
//   const loadPayments = useStore((state) => state.loadPayments); // Fetch payments for a specific client
//   const payments = useStore((state) => state.payments); // Access client payments from Zustand

//   useEffect(() => {
//     if (clientInfo?.id) {
//       loadPayments(clientInfo.id); // Load payments for the logged-in client
//     }
//   }, [clientInfo, loadPayments]);

//   return (
//     <div className="max-w-6xl mx-auto p-6">
//       <h1 className="text-2xl font-bold mb-6 text-center">My Payment Records</h1>
...
// export default ClientPaymentRecord;
...
const ClientPaymentRecord = () => {
  ...
  useEffect(() => {
    filterPayments(); // Filter payments whenever payments, searchTerm, or filter changes
  }, [payments, searchTerm, filter, startDate, endDate]);
  ...
  return (
    <div className="max-w-6xl  p-6 bg-white">
      ...
      <div className="flex justify-between items-center mb-4">
        <input
          type="text"
          placeholder="Search by Mpesa Ref, Order ID, or Amount"
          value={searchTerm}
      ...
      <div className="flex justify-end mt-4 max-w-1/4">
